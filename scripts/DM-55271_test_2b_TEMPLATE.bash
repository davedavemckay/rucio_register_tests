...
export TEST_NAME="DM-55271-test_2b"
...
butler query-dataset-types "$BUTLER_REPO" --collections "$COLLECTION" | tail -n +3 | awk '{print $1}' | head -n 20 | while IFS= read -r TYPE; do
